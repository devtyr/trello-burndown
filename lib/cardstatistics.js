...
CardStatistics.prototype.generate = function(cards, finishList, standuptime, name, callback) {
...
CardStatistics.prototype.export = function(data, resources, days, callback) {
	...
	saveJSON(statsData, name, callback);
}
...
function saveJSON(data, name, callback) {
	var dir = path.join(settings.root, 'export');
